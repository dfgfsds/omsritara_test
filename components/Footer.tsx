    ...
    <footer className="bg-[#222222] text-gray-400 px-6 lg:px-20 py-12 text-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-10">
        ...
        <div>
          <h3 className="font-semibold mb-4 uppercase">Shop</h3>
          <ul className="space-y-2">
            <li><Link href="/categories/bracelet" className="hover:text-white">Bracelet</Link></li>
            <li><Link href="/categories/mala" className="hover:text-white">Mala</Link></li>
            <li><Link href="/categories/spiritual-statues" className="hover:text-white">Spiritual Statues</Link></li>
            <li><Link href="/categories/rings" className="hover:text-white">Rings</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="mailto:info@omsritara.com" className="text-purple-400">
                info@omsritara.com
              </a>
            </li>
            <li>
              Ph No:{" "}
              <a href="tel:+918989052020" className="text-purple-400">
                +91-89890-52020
              </a>
            </li>
            <li className="mt-2">
        ...
        <div>
          <h3 className="font-semibold mb-4 uppercase">Newsletter</h3>
          <p className="mb-4">
            Om Sritara is an authentic online crystal shop offering natural healing stones, Reiki products, and spiritual accessories.
          </p>

          <div className="flex gap-3">
            <a
              href="https://www.facebook.com/omsritarafoundation/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Omsritara Facebook"
              className="bg-slate-100 p-2 rounded-full hover:scale-110 transition"
            >
              <Facebook size={16} />
            </a>

            <a
              href="https://x.com/Omsritara"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Omsritara Twitter"
              className="bg-slate-100 p-2 rounded-full hover:scale-110 transition"
            >
              <Twitter size={16} />
            </a>
            ...
            <a
              href="https://www.youtube.com/channel/UCxXJOgXcbckwNby5kEFkBjA"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Omsritara YouTube"
              className="bg-slate-100 p-2 rounded-full hover:scale-110 transition"
            >
              <Youtube size={16} />
            </a>
            ...
            <a
              href="https://www.instagram.com/omsritara/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Omsritara Instagram"
              className="bg-slate-100 p-2 rounded-full hover:scale-110 transition"
            >
              <Instagram size={16} />
            </a>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-600 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs gap-2">
        <p>© 2025 OMSRITARA</p>
        <p>
          Powered by{" "}
          <a
